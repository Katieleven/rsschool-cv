...
- **Development Tools:** Hands-on experience with Git for version control, GitHub for code collaboration, NEXT.js,
- Figma for design integration, and VS Code as the primary code editor.
